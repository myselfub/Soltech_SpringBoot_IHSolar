  ...
  Sexy = {
    getOptions: function() {
      return {
        ...
        BoxStyles       : { 'width': 340 },
        OverlayStyles   : { 'backgroundColor': 'none', 'opacity': 0.7 },
        showDuration    : 200,
        closeDuration   : 100,
        moveDuration    : 500,
...
//      this.preloadImages();
    ...
    messageBox: function(type, message, properties, input) {
        ...
        else if(type == 'confirm2')
        {
            ...
            $('#'+this.options.name+'-Buttons').append('<input id="BoxConfirmBtnOk" type="submit" /> <input id="BoxConfirmBtnCancel" type="submit" />');
            $('#BoxConfirmBtnOk').val('Yes').css({'width':70});
            $('#BoxConfirmBtnCancel').val('No').css({'width':70});
    ...
    */
    ...
    confirm2: function(message, properties){
        this.messageBox('confirm2', message, properties);
      },
